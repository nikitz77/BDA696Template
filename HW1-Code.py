...
##  3) Line graph
#		group by class and have a different color for each class
#       This looks messy because it was a line graph that had to go through each point in the scatterplot. I will have to refine this later to just reflect a trendline.
...
## 6) multiple scatter plots in different styles.
...
#This one seems to be weasier to explain because it has less parameters. 
